...
![1697958240806](认证授权/1697958240806.png)

授权:

![1697958252996](认证授权/1697958252996.png)
...
![1697958551199](认证授权/1697958551199.png)

**在 RBAC 中，权限与角色相关联，用户通过成为适当角色的成员而得到这些角色的权限。这就极大地简化了权限的管理。**

本系统的权限设计相关的表如下（一共 5 张表，2 张用户建立表之间的联系）：

![1697958595040](认证授权/1697958595040.png)

通过这个权限模型，我们可以创建不同的角色并为不同的角色分配不同的权限范围（菜单）。

![1697958753227](认证授权/1697958753227.png)

通常来说，如果系统对于权限控制要求比较严格的话，一般都会选择使用 RBAC 模型来做权限控制。

## 什么是Cookie？Cookie的作用是什么？

![1697958846578](认证授权/1697958846578.png)
...
![1697959950684](认证授权/1697959950684.png)
...
![1697960731332](认证授权/1697960731332.png)
